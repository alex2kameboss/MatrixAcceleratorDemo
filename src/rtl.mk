...
bender_vsim:
	bender script -D COMMON_CELLS_ASSERTS_OFF -t tech_cells_generic_include_tc_sram -t tech_cells_generic_include_tc_clk -t exclude_first_pass_decoder -t cv32a6_imac_sv0 -t sim_demo -t rtl --vlog-arg="-suppress vlog-13528 -suppress vlog-13233 -svinputport=compat -timescale 1ns/1ns" vsim > ${SIM_DIR}/compile.tcl
...
bender_vcs:
	bender script -D COMMON_CELLS_ASSERTS_OFF -t tech_cells_generic_include_tc_sram -t tech_cells_generic_include_tc_clk -t exclude_first_pass_decoder -t cv32a6_imac_sv0 -t sim_demo -t rtl --vlog-arg="-svinputport=compat -override_timescale=1ns/1ns -work work" vcs > ${VCS_DIR}/compile.sh ; chmod +x ${VCS_DIR}/compile.sh
...
bender_vivado:
	bender script -D COMMON_CELLS_ASSERTS_OFF -t tech_cells_generic_include_tc_sram -t tech_cells_generic_include_tc_clk -t exclude_first_pass_decoder -t cv32a6_imac_sv0 -t rtl -t fpga -t xilinx -t fpga_demo -t vcu128 vivado > ${SIM_DIR}/../vivado.tcl
